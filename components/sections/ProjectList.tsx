...
export default function ProjectList({projects}: { projects: Project[] }) {
    ...
    return (
        <div className={'flex-col-center gap-6'}>
            <div
                className={'grid grid-cols-3 max-[960px]:grid-cols-1 max-[1420px]:grid-cols-2 justify-items-stretch w-full  gap-20'}>
                {
            ...
            {
                projects.length > MAX_DISPLAYED_PROJECTS && localProjects.length !== projects.length  &&   <Button onClick={() => setLocalProjects(projects)}>See all</Button>
            }
        </div>
